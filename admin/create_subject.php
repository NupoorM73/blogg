    ...
    <table class="table table-bordered table-responsive">
       <tr>
        <td><label class="control-label">subjectname</label><b style="color:red">*</b></td>
           <td><input class="form-control" type="text" name="subjectname" required autofocus placeholder="Enter subjectname" value="" /></td>
       </tr>
       ...
       <tr>
        <td colspan="2"><button type="submit" name="btnsave" style="background-color: blue;color:white" class="btn btn-default">
           <span class="glyphicon glyphicon-save"></span> &nbsp; Save Subject
           </button>
        </td>
       </tr>
       </table>
