...
if($total_rows>0){
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            echo "<tr>";
                ...
                echo "<td>";
                    ...
                    echo "<a href='update_comm.php?comment_id={$comment_id}' class='btn btn-info left-margin'>";
                        echo "<span class='glyphicon glyphicon-edit'></span> Add Comment";
                    echo "</a> &nbsp";
 
                    // delete downloads button
                    echo "<a href='delete_comm.php?comment_id={$comment_id}' class='btn btn-danger delete-object'>";
 ...
 $page_url="read_comm.php?";
    $total_rows = $comment->countAllc();
    // paging buttons
...
// tell the user there are no products
    ...
    echo "<div class='alert alert-danger'>No Comments found.</div>";
}
?>
